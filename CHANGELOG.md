...
- Implemented DEP-01-05 source for verified pre-update backup, health-gated Repair/Upgrade rollback and retained-data Uninstall with explicit lifecycle evidence.
