...
- DEP-01 Full Offline Windows Installer: DEP-01-01 is complete/merged/CI verified through PR #177 and CI #609. DEP-01-02 exact-input freeze and deterministic staging/build source is implemented locally with PR/CI pending. Service lifecycle, executed Setup and clean-machine qualification are not yet claimed.
