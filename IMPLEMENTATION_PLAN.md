...
**Current controlled delivery sequence — reconciled 1 September 2026 after P7-02 closure**
...
- **P7-03 — License Lifecycle and Installation Binding UI — is the next controlled work package and the required starting point for the next implementation session.**
...
3. Start a controlled P7-03 branch from the current authoritative `main`.
4. Review the existing P5 platform license contracts, repository/API behavior, P7-01 owner boundary, and P7-02 platform query/session isolation before implementing UI mutations or new backend capability.
5. Keep payment settlement, invoicing, and live remote OTA/update execution outside P7-03 unless separately approved and implemented.
