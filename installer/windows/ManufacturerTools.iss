...
Name: "{commondesktop}\BIO-EMS Manufacturer Owner Signer"; Filename: "powershell.exe"; Parameters: "-NoProfile -ExecutionPolicy Bypass -File ""{app}\Invoke-ManufacturerOwnerSigner.ps1"" -ToolRoot ""{app}"""; WorkingDir: "{app}"; Tasks: desktopicon
