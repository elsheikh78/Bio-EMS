...
export const getAlarms = asyncHandler(
...
export const getActiveAlarms = asyncHandler(
    async (_req: Request, res: Response) => {
...
export const getAlarmById = asyncHandler(
...
export const acknowledgeAlarm = asyncHandler(
    async (req: Request, res: Response) => {
