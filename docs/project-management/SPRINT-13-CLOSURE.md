...
| ------ | ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------- | ------------------- |
| S13-01 | User domain and persistence; merged                                                        | PR #3; `4160fd4df050eb30170aeb1c902e6b3a7fb6d8c6`                                                                                                                                           | User entity, migration, repository, uniqueness, and fresh/upgrade migration tests                    | PR #3 CI evidence; no blocker found                                          | Completed           |
| S13-02 | Secure ADMIN bootstrap; merged                                                             | PR #3; `acfb76010f85c171389dd346b72c1e46382420bd`                                                                                                                                           | Password service, bootstrap command/service, duplicate-safe behavior, hashing, and safe-log tests    | PR #3 CI evidence; no blocker found                                          | Completed           |
| S13-03 | Login and access-token issuance; merged                                                    | PR #3; `44388acb28581c2ccf0240edccc78d2d7965f239`                                                                                                                                           | Auth route/service, JWT configuration/token service, and login/token tests                           | PR #3 CI evidence; no blocker found                                          | Completed           |
| S13-04 | Authentication middleware, persisted active-User enforcement, and test isolation; merged   | PR #3; `37e0af9eb551cf8184271b7a45928cda882f4cb8`, `b4ba6db4b5fbdb810a0462c001c47f4e5707a2b6`                                                                                               | Authentication middleware plus application, repository, token, and middleware regressions            | Run 31400103719 succeeded                                                    | Completed           |
...
| S13-08 | Correct documentation and prepare closure evidence; implementation complete on this branch | This documentation branch and its Draft PR                                                                                                                                                  | Eight documentation/configuration-example artifacts; full local gates below                          | Independent review and controlled merge required                             | Partially completed |
...
| Engineering Playbook           | Stale JWT name and authentication status         | Correct configuration and operational guidance   |
| `backend/.env.example`         | Missing JWT and bootstrap variables              | Add safe names and non-secret example values     |
