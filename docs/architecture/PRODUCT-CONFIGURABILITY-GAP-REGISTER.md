...
| CFG-009 | Configuration UI              | BF-09-06 closes Sensor/Recipient/Policy and User/Audit workflows with explicit Site scope and regression | Provider execution, controller runtime, and field evidence remain separately scoped       | IMPLEMENTED / BF-09 VERIFIED  |
