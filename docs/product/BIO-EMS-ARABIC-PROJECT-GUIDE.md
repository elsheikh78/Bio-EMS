...
## الحالة الحالية — 31 أغسطس 2026

- الإصدار البرمجي الحالي: `0.16.3`.
- مركز التقارير يوفّر Preview وCSV وPDF لخمسة تقارير: المعايرة، الأداء الحراري، سجل
  الإنذارات، صحة اتصال الأجهزة، والتدقيق والعمليات.
- ملفات PDF التشغيلية تستخدم هوية BIO-EMS، توقيت الموقع، ملخصًا تنفيذيًا، بيان جودة البيانات،
  وترقيم الصفحات.
- Dashboard وMonitored Areas يتحدثان تلقائيًا عبر SSE بعد قبول القراءة، مع polling احتياطي منخفض
  التكرار.
- الاختبارات البرمجية والـCI ناجحة، لكن اختبار MQTT على البيئة المركبة وCommissioning واعتماد عميل
  BIO EGYPT ما زالت أدلة ميدانية غير مكتملة؛ حالة الـPilot: **NOT COMMISSIONED / NOT ACCEPTED**.
- المرحلة التالية هي محرك إرسال الإشعارات الفعلي، ثم Site Controller Runtime، قبل UPF ومنصة
  العملاء والتراخيص.
