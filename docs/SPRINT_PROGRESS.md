...
On 3 September 2026 P8-01A approved Telegram as a distinct interim primary channel rather than relabeling WhatsApp. Source implementation extends recipient, escalation, durable delivery, Delivery Operations and configuration UI contracts and adds a controlled Telegram smoke test. It closed through PR #158 / CI run #549 / merge `c90cdde2e260730f70d38d6f22fa091a415961a4`. Live bot, Chat ID, receipt and end-to-end `TELEGRAM + EMAIL` evidence remain open; WhatsApp remains available for later activation and SMS remains emergency fallback.
